...
#message_str = "This is a very secret message!"
 ...
 # whether or not to force finish sent. If so, stats displayed will be for non-finished sentence
...
"""
def encoder(message_str, context, enc, model):
    unicode_enc = True
    mode = 'arithmetic'
...
def decoder(text, context, enc, model):
    unicode_enc = True
    mode = 'arithmetic'
    block_size = 3 # for huffman and bins
    temp = 0.9 # for arithmetic
